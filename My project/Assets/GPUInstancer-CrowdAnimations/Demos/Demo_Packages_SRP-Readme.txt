...
- If you are using Universal Render Pipeline, you can extract the package "Crowd_Animations-URP_Demos_Package_(10_&_Later)" under the "GPUInstancer-CrowdAnimations/Demos/" folder.
- If you are using High Definition Render Pipeline, you can extract the package "Crowd_Animations-HDRP_Demos_Package_(10_&_Later)" under the "GPUInstancer-CrowdAnimations/Demos/" folder.

If you are using a Unity version below 2020.2, you can extract the SRP 8 and before packages:
- If you are using Universal Render Pipeline, you can extract the package "Crowd_Animations-URP_Demos_Package_(8_&_Before)" under the "GPUInstancer-CrowdAnimations/Demos/" folder.
- If you are using High Definition Render Pipeline, you can extract the package "Crowd_Animations-HDRP_Demos_Package_(8_&_Before)" under the "GPUInstancer-CrowdAnimations/Demos/" folder.

These packages contain the SRP versions of the demo scene materials, custom shaders, and in some cases scene files and new textures as well. 
...
ShaderGraph 10 versions of Crowd Animations shaders.
